...
c. The Interval is **(96.9382, 99.6822)**   
```{r}
c(fit21 - 1.96 * 0.7, fit21 + 1.96 * 0.7)
```
...
b. The 95% confidence interval for beta1 is **(-0.022032, -0.005568)**     
...
```{r}
c(-0.0138 - 1.96 * 0.0042, -0.0138 + 1.96 * 0.0042)
```
